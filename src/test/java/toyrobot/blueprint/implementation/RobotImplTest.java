...
class RobotImplTest {
	...
	void testMove() {
		robot.setNextMove(Movement.WEST);
		robot.move();
		assertEquals(new Coordinate(0, 0), robot.getLocation());
		robot.setNextMove(Movement.SOUTH);
		robot.move();
		assertEquals(new Coordinate(0, 0), robot.getLocation());
		robot.setNextMove(Movement.NORTH);
		robot.move();
		assertEquals(new Coordinate(0, 1), robot.getLocation());
		robot.setNextMove(Movement.EAST);
		robot.move();
		assertEquals(new Coordinate(1, 1), robot.getLocation());
		robot.setNextMove(Movement.WEST);
		robot.move();
		assertEquals(new Coordinate(0, 1), robot.getLocation());
		robot.setNextMove(Movement.SOUTH);
	...
	void testGetLocation() {
		...
		robot.setNextMove(Movement.SOUTH);
		robot.move();
		assertEquals(new Coordinate(1, 0), robot.getLocation());
		robot.setNextMove(Movement.WEST);
		robot.move();
		assertEquals(new Coordinate(0, 0), robot.getLocation());
	}
